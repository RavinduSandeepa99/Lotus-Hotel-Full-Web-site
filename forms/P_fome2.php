...
<head>
  <title>ACCOMMODATION FORM-2</title>
  <link rel="stylesheet" href="css/P_fome2.css" /> 
</head>
    ...
    <div class="form">
       <div class="inputfield">
        ...
        <div class="inputfield">
          ...
          <input type="text" class="input" id="email" name="Mail" onkeydown="validation()" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"  title="Please Type Valid Email" required>
       </div>
        <span id="text0"></span>
       <div class="inputfield">
      ...
      <div class="inputfield">
       ...
       <input type="radio" id="STANDARD" name="Room" class="STANDARD"   value="DETAILS" checked>
